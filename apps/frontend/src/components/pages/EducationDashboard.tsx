...
import { SavingTipsPage } from './SavingTipsPage';
import PersonalizedAdvicePage from './PersonalizedAdvicePage';
                ...
                <Card key={advice.id} style={{ 
                  ...
                  <div style={{ padding: '16px' }}>
                    ...
                    <span style={{ 
                      ...
                      fontSize: '10px',
                      borderRadius: '12px',
                      backgroundColor: advice.priority === 'high' ? colors.error[100] : 
                                       advice.priority === 'medium' ? colors.warning[100] : colors.gray[100],
                      color: advice.priority === 'high' ? colors.error[800] : 
                             advice.priority === 'medium' ? colors.warning[800] : colors.gray[800],
                      fontFamily: "'Noto Sans KR', sans-serif"
                    }}>
